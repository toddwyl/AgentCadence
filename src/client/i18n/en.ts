export const en = {
  ...
  execution: {
    ...
    noSavedActivity: 'This historical step does not include a saved activity transcript.',
    noSavedRawLog: 'This historical step does not include a saved raw log.',
  ...
  settings: {
    title: 'Settings',
    subtitle: 'Manage app behavior, agents, and automation triggers',
    cliProfile: 'CLI',
    cliProfileHint:
